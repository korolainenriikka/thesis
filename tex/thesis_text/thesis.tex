...
approaches, reaching a final accuracy of 98,16\%. However, to achieve this accuracy, the exact best data augmentation parameters of 
...
% nextii. 
% joku muuki teki svm, kuka?
% joku muuki huomas et vit ei oo nii hyvä, kuka?

Details on all the works presented above are summarized on Table todo. Where multiple approaches 
were experimeted with, the highest accuracy relative to number of target classes and the three best 
base model variants are listed for brevity. The Tibetan detection article \cite{tibetan_ocr}
is omitted due to transfer setting being very different to the other works. If a detail is omitted,
it was not stated with sufficient clarity in the original work.

\section{Experimental setup}

\subsection{Base model, hyperparameter and transfer learning approach selection}

choose things based on articles
