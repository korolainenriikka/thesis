...
The two main pieces of prior knowledge encoded to the convolutional layer computation
 are invariance to transformations and local relatedness of pixels.
...
The convolution operation is filtering with cross correlation.

% % size changes & pooling operations. todo: notes
Cnns usually do vary the size of the weights a lot and for this pooling is used.
...
The architectures of the AlexNet, GoogLeNet and VGG models are summarized in Figure TODO.
...
\begin{figure}[h]
    ...
    \caption{Architectures of AlexNet~\cite{alexnet}, GoogLeNet~\cite{googlelenet}, and VGG-16, the 
    VGG model variant with 16 layers~\cite{vgg}, from~\cite{zhangImagebasedMethodsDietary2023}}
