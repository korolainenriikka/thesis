...
Paleoecology is a field that conducts data analysis on fossil data. The most common type of 
...
analysis on environemntal change can be performed even on a smaller timescale than evolution would allow \cite{fortelius}. As an example, both precipitation \cite{fortelius}
...
crown is required due to tooth erosion and that to digest browse, while cutting blades in teeth are required to cut the fibrous plants to pieces.
...
tooth types found in a region during a set geological time period. The previously learned function can then be applied to this data set
 to get knowledge on environmental conditions. Again, the true causal relationships are naturally much more complicated 
...
%theres human evolution (forteloius) and especially dense mammal record (fortelius) and many environemntal changes (nowdatabase)

Many studies completing paleoenvironmental reconstruction list data availability as the most major limitation (\cite{oksanenHumboldtianApproachLife2019}, \cite{fortelius}).
