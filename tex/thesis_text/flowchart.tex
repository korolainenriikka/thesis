...
\tikzstyle{arrow} = [thick, ->, >=stealth, draw=Maroon, shorten <= 3px, shorten >= 3px]
\tikzstyle{nonactivearrow} = [thick, ->, >=stealth, draw=Maroon!30, shorten <= 3px, shorten >= 3px]
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \draw[thick, draw=Blue] (2.1,-2) -- node[anchor=south] {other} (-1.7,-2) -- (-1.7,-8);
