...
\tikzstyle{nnmodel} = [trapezium, draw=black, fill=black!20, trapezium left angle=120, trapezium right angle=120]
\tikzstyle{textcontainer} = [rectangle]
\tikzstyle{imageframe} = [rectangle]
\tikzstyle{arrow} = [thick, ->, >=stealth, draw=black]
\tikzstyle{dashedarrow} = [thick, ->, >=stealth, draw=black, dashed]
\tikzstyle{nonactivearrow} = [thick, ->, >=stealth, draw=black!30]
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \draw [dashedarrow] (frag) -- (toothornot);
    ...
    \draw[thick, dashed] (toothornot) -- node[anchor=south] {other} (-1.7,-2) -- (-1.7,-8);
    \draw[->, thick, dashed] (-1.7,-8) -- (2.7,-8);
    \draw[thick, draw=black!30] (mpic) -- (8.5,-5) -- (8.5,-8);
    \draw[->, thick, draw=black!30] (8.5,-8) -- (4.7,-8);
\end{tikzpicture}
