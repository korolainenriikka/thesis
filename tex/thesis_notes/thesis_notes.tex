...
and reduces parameter count from fully connected layers.

relevant here: present the ImageNet competition that has initiated many new architectures.

\subsubsection{Convolutional layers}

% todo: read alexnet, googlelenet & vgg papers. get from there a good what is a convolution, why convolution section
...
% size changes & pooling operations.
max pooling / average pooling operations

% history bit: imageNet breakthrough models
